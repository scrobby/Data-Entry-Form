...
class ViewController: UIViewController, DataEntryFormDelegate {
    ...
    @IBAction func threeSetupsTapped(sender: AnyObject) {
		var newController = DataEntryFormController(formTypesWithTitles: [FormTypeWithTitle(formType: .Date, title: ""), FormTypeWithTitle(formType: .Amount, title: ""), FormTypeWithTitle(formType: .Text, title: "")], andAnimations: FormAnimations(showAnimation: .Right, dismissAnimation: .Left))
		newController.show()
    }
